...
dxb_config_validate() {
  ...
  for v in IGATE_RF_TO_IS IGATE_IS_TO_RF POSITION_LOG SERIAL_CONSOLE; do _dxb_is_onoff "${DXB_CFG[$v]}" || _dxb_err "$v" 'must be on or off'; done
